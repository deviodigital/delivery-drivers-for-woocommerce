...
class Delivery_Drivers_WooCommerce_Settings {
    ...
    /**
     * Uses the WooCommerce admin fields API to output settings via
     * the @see woocommerce_admin_fields() function.
     *
    ...
    /**
     * Uses the WooCommerce options API to save settings via
     * the @see woocommerce_update_options() function.
     *
    ...
    /**
     * Get all settings for this plugin for @see woocommerce_admin_fields() function.
     *
     * @return array
     */
