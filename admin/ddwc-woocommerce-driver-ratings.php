 ...
 * 
 * @TODO Update this to be in a separate file
 * 
 * @param object $order 
 *
 * @since  1.6
...
function ddwc_order_driver_details( $order ) {
    ...
    if ( '-1' !== $driver_id && '' !== $driver_id ) {
        ...
        // Make sure the driver vehicle details should be displayed.
        if ( 'no' !== get_option( 'ddwc_settings_driver_vehicle_details' ) ) {
